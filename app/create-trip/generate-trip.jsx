...
export default function GenerateTrip() {
  ...
  return (
    <View style={{padding:25 , paddingTop:75 , backgroundColor:Colors.WHITE, height:'100%'}}>
      ...
      <Text style={{fontFamily:'outfit-medium', fontSize:20, textAlign:'center', marginTop:40}}>We are working to generate your dream trip</Text>
   
      <Image
        source={{ uri: 'https://media.giphy.com/media/y1ZBcOGOOtlpC/200.gif' }}
